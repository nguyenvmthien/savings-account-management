...
class Regulation_H {
    async create({type, applied_date, applied_time, interest_rate, min_des_money, min_days_withdraw}) {
        try {
    ...
    async edit({type, applied_date, applied_time, interest_rate, min_des_money, min_days_withdraw}) {
        try {
    ...
    async getMinDesMoneyAndMinWithDays({type, applied_date, applied_time}) {
        try {
            ...
            console.error('Error getting min_des_money and min_days_withdraw:', err);
            throw err;
        }
    }
}
